...
def visualize_top_words(word_counts, top_n=15):
    ...
    plt.xlabel("Слова", fontsize=12, color="darkgreen")
    plt.ylabel("Частота використання", fontsize=12, color="darkgreen")
    plt.xticks(rotation=45, fontsize=10, color="darkgreen")
    plt.yticks(fontsize=10, color="darkgreen")
    plt.title(
        "Топ-слова з найвищою частотою використання", fontsize=16, color="darkgreen"
    )
    plt.show()
